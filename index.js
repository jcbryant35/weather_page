...
function displayCurrentWeather(d) {
    ...
    icon.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl}@2x.png"></img>`;
...
function displayFiveDayForecast(data, dataB) {
    ...
    icon1.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl1}@2x.png"></img>`;
    icon2.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl2}@2x.png"></img>`;
    icon3.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl3}@2x.png"></img>`;
    icon4.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl4}@2x.png"></img>`;
    icon5.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl5}@2x.png"></img>`;
...
function displayCurrentWeatherGPS(dataC) {
    ...
    gpsIcon.innerHTML = `<img src="https://openweathermap.org/img/wn/${gpsIconUrl}@2x.png"></img>`;
...
function displayFiveDayForecastGPS(dataD, dataE) {
        ...
        icon1.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl1GPS}@2x.png"></img>`;
        icon2.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl2GPS}@2x.png"></img>`;
        icon3.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl3GPS}@2x.png"></img>`;
        icon4.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl4GPS}@2x.png"></img>`;
        icon5.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrl5GPS}@2x.png"></img>`;
...
function displayFiveDayForecastC(dataJ, dataK) {
    ...
    let celMax5 = Math.round(((parseFloat(dataK.daily[4].temp.max)-273.15))); 
        ...
        icon1.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrlOne}@2x.png"></img>`;
        icon2.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrlTwo}@2x.png"></img>`;
        icon3.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrlThree}@2x.png"></img>`;
        icon4.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrlFour}@2x.png"></img>`;
        icon5.innerHTML = `<img src="https://openweathermap.org/img/wn/${iconUrlFive}@2x.png"></img>`;
